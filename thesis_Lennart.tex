...
\input{preamble.tex}
 ...
 \makeatletter %Next three lines added to create double lines in the table of contents in case of long titles
	\def\@pnumwidth{3em}
\makeatother
...
\input{SNP_Indel.tex}
\input{CoNVaDING.tex}
\input{opportunistic_screening.tex}
\input{Part2.tex}
