...
\chaptermark{Translocation detection in leukemia}
\label{chap:TLA}
...
\textsl{Test set}. To assess the performance of the multiplex TLA procedure, we selected, anonymized, and tested a set of 19 patient bone marrow samples, as described above, using the optimum thresholds from the training set analysis. 
...
In total, above 10\% aberrant cells, 20 translocation calls were made, of which 3 were labeled as grayzone. 
...
\begin{table}[H] %the [H] is to force the footnotes on the same page as the table
	...
	\caption[TLA and benchmarking of results]{\label{table:TLA_benchmark} TLA and benchmarking of the results from the training and test sets}
	\resizebox{\linewidth}{!}{\begin{tabulary}{\linewidth}{p{1cm}p{1.2cm}p{2.3cm}p{1.2cm}p{1cm}p{1cm}p{0.9cm}}
			...
			\hline
			Training 	& set& & & & & \\
			\rule{0pt}{1ex} 1 & ALL & t(12;21)(p13;q22) & -\footnotemark[1] & n/a & +\footnotemark[2] & + \\
			...
			\rule{0pt}{1ex} 13 & AML & t(15;17)(q24;q21) & + & + & + & n/a \\
