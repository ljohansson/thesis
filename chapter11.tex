...
This extra layer of information can be obtained via single-cell DNA sequencing (sc-seq) using short-read NGS [van den Bos et al., 2018; Price et al., 2018]. 
...
Apart from nested PCR using an initial long-range PCR combined with Sanger sequencing [Michalatos-Beloin et al., 1996; Tan et al., 2012], these are all NGS techniques. 
Existing long-read sequencing techniques such as PacBio SMRT sequencing [Chaisson et al., 2015] and Oxford NanoPore Technologies (ONT) [Jain et al., 2018a][Nanopore, n.d.] can already achieve read lengths up to 100 kb and over 2 Mb, respectively. 
With the costs of long-read sequencing decreasing [Van Dijk et al., 2018], it might eventually be feasible to use these techniques for sequencing in diagnostics.
...
On the road to a complete DNA sequencing technology, ONT has an extra feature: it allows for detection of epigenetic alterations of nucleotides during sequencing [Jain et al., 2018a]. 
...
Currently, several techniques (such as 3C, 4C and HiC) are available to analyze these kinds of interactions [Spielman et al., 2018]. 
